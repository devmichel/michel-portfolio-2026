...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[921px] flex items-center px-8 py-20 overflow-hidden" id="hero">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-6 pt-4">
            <a href="#contact" className="neumorphic-button-primary px-10 py-4 rounded-xl text-white font-bold text-lg inline-flex active:scale-95 transition-all">
              {t('start')}
            </a>
            <a href="#projects" className="neumorphic-raised px-10 py-4 rounded-xl text-on-surface font-bold text-lg hover:shadow-lg active:scale-95 transition-all inline-flex">
              {t('portfolio')}
            </a>
          </div>
        </div>
